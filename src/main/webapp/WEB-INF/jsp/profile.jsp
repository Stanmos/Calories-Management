        ...
        <div class="row">
            <div class="col-5 offset-3">
                ...
                <form:form class="form-group" modelAttribute="userTo" method="post" action="profile"
                    ...
                    <calc:inputField labelCode="user.name" name="name"/>
                    <calc:inputField labelCode="user.email" name="email"/>
                    <calc:inputField labelCode="user.password" name="password" inputType="password"/>
                    <calc:inputField labelCode="user.caloriesPerDay" name="caloriesPerDay" inputType="number"/>
